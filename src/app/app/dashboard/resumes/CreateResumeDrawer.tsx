  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent
        ...
        className="max-h-[90vh] h-[90vh] p-0 overflow-hidden bg-white/95 dark:bg-gray-950/95 backdrop-blur-2xl border-white/20 dark:border-white/10 shadow-2xl rounded-t-[2rem] flex flex-col"
      >
