        ...
        >
            ...
            >
                <CardContent className="p-0 flex-1 relative bg-gray-50 dark:bg-gray-900 overflow-hidden cursor-pointer">
                    ...
                    <div className="absolute inset-x-0 bottom-0 top-[40%] pointer-events-none bg-gradient-to-t from-white via-white/90 to-transparent dark:from-gray-950 dark:via-gray-950/90 z-0"></div>
                    <div className="absolute inset-x-0 bottom-0 pt-12 pb-3 px-2 flex justify-between items-end border-t border-transparent z-10 transition-colors group-hover:bg-white/50">
                        <div className="flex flex-col w-full">
                            ...
                            <span className="text-[11px] text-gray-600 dark:text-gray-300 mt-0.5 font-medium">
                                {t(`dashboard.templates.${templateNameKey}.name`)} · {dayjs(resume.createdAt).format('YYYY-MM-DD HH:mm')}
                            </span>
                        </div>
                    </div>
                </CardContent>
